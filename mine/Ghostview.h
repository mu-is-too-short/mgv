...
#ifndef	GHOSTVIEW_H
#define	GHOSTVIEW_H
MU_HID(ghostview_h, "$Mu: mgv/mine/Ghostview.h 1.35 1999/08/29 20:26:57 $")
...
#define	GvNpostScriptForeground		"postScriptForeground"
#define	GvNpostScriptBackground		"postScriptBackground"
...
#define	GvCPostScriptForeground		"PostScriptForeground"
#define	GvCPostScriptBackground		"PostScriptBackground"
 ...
 */
typedef int GvOrient;
#define GvOrientPortrait	((GvOrient)  0)
#define GvOrientLandscape	((GvOrient) 90)
#define GvOrientUpsideDown	((GvOrient)180)
#define GvOrientSeascape	((GvOrient)270)
...
extern	GvOrient	GhostviewGetOrientation(Widget);
