 ...
 */
#include <wlib/rcs.h>
MU_ID("$Mu: mgv/toolbar.c 1.6 1998/11/22 13:40:55 $")
...
#include <lib/toolbar/markInvert-i.xbm>
#include <lib/toolbar/markInvert-i.xpm>
#include <lib/toolbar/markInvert.xbm>
#include <lib/toolbar/markInvert.xpm>
...
static WlToolBarImage internal[] = {
	{
		...
		"markInvert",
		markInvert_xpm, markInvert_i_xpm,
		markInvert_width, markInvert_height,
		markInvert_bits, markInvert_i_bits
	}, {
		"pageNext",
